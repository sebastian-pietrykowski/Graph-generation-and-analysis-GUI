 ...
 * and random edges' weights in range (from_weight, to_weight). */
 ...
 * connected and with random edges' weights in of range (from_weight, to_weight).
 * It has edges leading from vertex with number "start_vertex_number"
 * to all vertices in graph. */
 ...
 * and with random edges' weights in range (from_weight, to_weight). */
